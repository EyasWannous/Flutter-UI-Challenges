...
class HorizontalSnappingList extends StatefulWidget {
  ...
  @override
  HorizontalSnappingListState createState() => HorizontalSnappingListState();
}

class HorizontalSnappingListState extends State<HorizontalSnappingList> {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, i) {
          double scale =
              ((1 - math.min((i - scrollOffset).abs(), 1.0)) * (1 - 0.85));
