  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const F4FBottomBarWidget(
        sections: [
          F4FBottomBarSection(
            title: 'Blog Post in Flutter 4 Fun',
            link: 'https://flutter4fun.com/ui-challenge-4/',
          ),
          if (!kIsWeb)
            F4FBottomBarSection(
              title: 'Live Demo',
              link: 'https://flutter4fun.github.io/ui_challenge_4_live/#/',
            ),
          F4FBottomBarSection(
            title: 'Source Code',
            link: 'https://github.com/Flutter4Fun/ui_challenge_4/',
          ),
        ],
      ),
    );
