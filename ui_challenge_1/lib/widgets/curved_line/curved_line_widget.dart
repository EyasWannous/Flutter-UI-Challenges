...
class CurvedLineWidget extends StatelessWidget {
  ...
  const CurvedLineWidget({
    ...
    List<Color>? gradientColors,
        ...
        gradientColors =
            gradientColors ?? const [Color(0x6600B0FF), Color(0x0000B0FF)],
        super(key: key);
...
class _CurvedLineCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final controlPoint = Offset((point2.dx - point1.dx) / 2,
        point1.dy - (curveHeight * 2) + lineThickness);
    ...
    glowAreaPath.lineTo(point1.dx, point1.dy);
