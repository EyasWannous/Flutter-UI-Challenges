...
class AnimatedCurveLine extends StatefulWidget {
  ...
  const AnimatedCurveLine({Key? key, required this.colorsToAnimate})
      : super(key: key);

  @override
  _CurvedLineAnimatedWidgetState createState() =>
      _CurvedLineAnimatedWidgetState();
}
...
class _CurvedLineAnimatedWidgetState extends State<AnimatedCurveLine>
  ...
  void animateToNextColor() {
    ...
    _controller =
        new AnimationController(vsync: this, duration: getRandomDuration());
